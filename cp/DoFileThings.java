...
/** 	
Copyright Helen Imogen Field 2004-2060.
...
import java.io.*;
import java.awt.*;//for file dialogs
...
class DoFileThings
{
	...
	{	boolean b = false;
		if (br != null) b = true;
		p("ReadFileopen: "+b);//in use by CPG
		return b;
	}
	...
	{	boolean b = false;
		...
		if (filename != null)
		{
			...
			catch (FileNotFoundException e){ p("DoFileThings.openReadFile: "+e);}
		}
		return false;
	}
	...
	public String getAll(String filename)
	{
		...
		if(openReadFile(filename))
			...
			p("openReadFile "+filename+" failed");
		return s;
	}
